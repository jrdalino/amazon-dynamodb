...
```
$ vi ~/environment/my-project-name/aws-cli/dynamodb-table.json
```
...
--cli-input-json file://~/environment/my-project-name/aws-cli/dynamodb-table.json
```

### Step 1.3: Validate that our table has been created
```
$ aws dynamodb describe-table \
--table-name MyDynamoDBTable
```

### Step 1.4: Scan our table
```
$ aws dynamodb scan \
--table-name MyDynamoDBTable
```

### Step 1.5: Prepare items to Insert
```
$ vi ~/environment/my-project-name/aws-cli/populate-dynamodb.json
```
...
### Step 1.6: Add Items to the DynamoDB Table
```
$ aws dynamodb batch-write-item \
--request-items file://~/environment/my-project-name/aws-cli/populate-dynamodb.json
```

### Step 1.7: Let's rescan our table
```
$ $ aws dynamodb scan \
--table-name MyDynamoDBTable
```

### Step 1.8: Modify our application code to read from this table instead of returning the static JSON file

### Step 1.9: Push Updated Backend Code into the CI/CD Pipeline
```
